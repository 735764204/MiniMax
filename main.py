...
class GameRunner:
        ...
        while True:
            ...
            if self.auto and not game_over:
                ...
                if not self.ec:
                    ...
                    self.num_ite += 1
                    self.dict_ite_f[self.num_ite] = self.game.score
                else:
            ...
            if game_over:
                ...
                # If want to plot, uncomment the following
                return self.dict_ite_f
                pygame.quit()
                sys.exit()
    ...
    #     print("Begin to plot")
    #     print(len(self.dict_ite_f))
    #     self.dict_ite_f = dict(list(self.dict_ite_f.items())[:2000])
    #     X = [key for key in self.dict_ite_f]
    #     Y = [self.dict_ite_f[key] for key in self.dict_ite_f]
    #     plt.plot(X, Y, color='k')
    #     plt.xlabel("number of moves")
    #     plt.ylabel("score")
    #     plt.title("score/number of moves Curve")
    #     plt.show()
    #     print(self.dict_ite_f)
